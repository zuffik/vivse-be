  ...
  */
  ...
  > = S extends true
    ...
    ? 'include' extends U
      ...
      : 'select' extends U
      ? {
          [P in TrueKeys<S['select']>]: P extends keyof AlbumCountOutputType
            ? AlbumCountOutputType[P]
            : never;
        }
      : AlbumCountOutputType
    : AlbumCountOutputType;
  ...
  > = S extends true
    ...
    ? 'include' extends U
      ...
      : 'select' extends U
      ? {
          [P in TrueKeys<S['select']>]: P extends keyof PhotoCountOutputType
            ? PhotoCountOutputType[P]
            : never;
        }
      : PhotoCountOutputType
    : PhotoCountOutputType;
  ...
  export interface AlbumDelegate<GlobalRejectSettings> {
    ...
    ): PrismaPromise<GetAlbumAggregateType<T>>;
  ...
  export interface ImageFileDelegate<GlobalRejectSettings> {
     ...
     **/
    findUnique<
      T extends ImageFileFindUniqueArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    > extends True
      ? CheckSelect<
          T,
          Prisma__ImageFileClient<ImageFile>,
          Prisma__ImageFileClient<ImageFileGetPayload<T>>
        >
      : CheckSelect<
          T,
     ...
     **/
    findFirst<
      T extends ImageFileFindFirstArgs,
      LocalRejectSettings = T['rejectOnNotFound'] extends RejectOnNotFound
        ? T['rejectOnNotFound']
        : undefined,
    >(
    ...
    findMany<T extends ImageFileFindManyArgs>(
      ...
      T,
      PrismaPromise<Array<ImageFile>>,
      PrismaPromise<Array<ImageFileGetPayload<T>>>
    >;
     ...
     * })
     **/
    aggregate<T extends ImageFileAggregateArgs>(
      args: Subset<T, ImageFileAggregateArgs>,
    ): PrismaPromise<GetImageFileAggregateType<T>>;
    ...
    >(
      args: SubsetIntersection<T, ImageFileGroupByArgs, OrderByArg> &
        InputErrors,
    ): {} extends InputErrors
      ? GetImageFileGroupByPayload<T>
      : Promise<InputErrors>;
  }
  ...
  export interface PhotoDelegate<GlobalRejectSettings> {
    ...
    ): PrismaPromise<GetPhotoAggregateType<T>>;
  ...
  > = S extends true
    ...
    ? 'include' extends U
      ...
      : 'select' extends U
      ? {
          [P in TrueKeys<S['select']>]: P extends keyof Url ? Url[P] : never;
        }
      : Url
    : Url;
  ...
  export interface UrlDelegate<GlobalRejectSettings> {
    ...
    > extends True
      ? CheckSelect<
          T,
          Prisma__UrlClient<Url>,
          Prisma__UrlClient<UrlGetPayload<T>>
        >
      : CheckSelect<
          T,
          Prisma__UrlClient<Url | null>,
          Prisma__UrlClient<UrlGetPayload<T> | null>
        >;
    ...
    findMany<T extends UrlFindManyArgs>(
      ...
      T,
      PrismaPromise<Array<Url>>,
      PrismaPromise<Array<UrlGetPayload<T>>>
    >;
    ...
    ): PrismaPromise<GetUrlAggregateType<T>>;
    ...
    ): {} extends InputErrors ? GetUrlGroupByPayload<T> : Promise<InputErrors>;
  }
  ...
  export type ImageFileScalarFieldEnum =
    typeof ImageFileScalarFieldEnum[keyof typeof ImageFileScalarFieldEnum];
  ...
  export type PhotoCreateNestedManyWithoutAlbumInput = {
    create?: XOR<
      ...
      Enumerable<PhotoUncheckedCreateWithoutAlbumInput>
    >;
  ...
  export type AlbumCreateNestedManyWithoutMainInput = {
    create?: XOR<
      Enumerable<AlbumCreateWithoutMainInput>,
      Enumerable<AlbumUncheckedCreateWithoutMainInput>
    >;
  ...
  export type AlbumCreateOrConnectWithoutMainInput = {
    where: AlbumWhereUniqueInput;
    create: XOR<
      AlbumCreateWithoutMainInput,
      AlbumUncheckedCreateWithoutMainInput
    >;
  };
  ...
  export type AlbumUpsertWithWhereUniqueWithoutMainInput = {
    where: AlbumWhereUniqueInput;
    update: XOR<
      AlbumUpdateWithoutMainInput,
      AlbumUncheckedUpdateWithoutMainInput
    >;
    create: XOR<
      AlbumCreateWithoutMainInput,
      AlbumUncheckedCreateWithoutMainInput
